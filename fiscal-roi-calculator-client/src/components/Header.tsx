...
export function Header() {
  const { viewMode, setViewMode, recalculate, resetToDefaults } = useCalculator();
  ...
  return (
    <header className="border-b pb-4 flex flex-col sm:flex-row justify-between items-center gap-4">
      <div className="flex items-center">
        <h1 className="text-2xl font-bold text-fiscal-purple">FISCAL ROI Calculator</h1>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Dialog open={isAdminOpen} onOpenChange={setIsAdminOpen}>
          ...
          <DialogContent className="sm:max-w-[600px]">
            ...
            <AdminSettingsForm onClose={() => setIsAdminOpen(false)} />
          </DialogContent>
        </Dialog>
